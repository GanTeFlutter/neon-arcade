...
class $AssetsSongsGen {
  ...
  /// File path: assets/songs/blip.mp3
  String get blip => 'assets/songs/blip.mp3';

  /// File path: assets/songs/buzz.mp3
  String get buzz => 'assets/songs/buzz.mp3';

  /// File path: assets/songs/chime.mp3
  String get chime => 'assets/songs/chime.mp3';

  /// File path: assets/songs/perfect.mp3
  String get perfect => 'assets/songs/perfect.mp3';

  /// File path: assets/songs/synth_arpeggio.mp3
  String get synthArpeggio => 'assets/songs/synth_arpeggio.mp3';

  /// List of all assets
  List<String> get values => [blip, buzz, chime, perfect, synthArpeggio];
}
